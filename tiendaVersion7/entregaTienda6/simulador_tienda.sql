...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2025 a las 13:16:24
...
(1, 'Manzana', 'Manzana Envy: Crujiente, dulce y jugosa.', 20, 1, 0.50),
(2, 'Avocado', 'Aguacates Hass cremosos, perfectos para guacamole.', 20, 1, 1.20),
(3, 'Bananas', 'Plátanos de Canarias: Dulces, cultivo tradicional.', 20, 1, 0.25),
(4, 'Arandanos', 'Arándanos frescos, alto contenido en fibra.', 25, 1, 2.50),
(5, 'Pan', 'Pan de Masa Madre artesanal. Horneado diariamente.', 30, 3, 2.80),
(6, 'Cebollas', 'Cebollas enteras', 15, 2, 0.20),
(7, 'Zanahorias', 'Zanahorias Gigantes, dulces. Ideales para zumos.', 50, 2, 0.15),
(8, 'Naranjas', 'Naranjas Navel de Valencia. Muy jugosas.', 35, 1, 0.30),
(9, 'Peras', 'Peras Conferencia. Pulpa fina, muy jugosa.', 44, 1, 0.45),
(10, 'Sandias', 'Sandías sin Pepitas. Refrescantes y con agua.', 25, 1, 4.00);
